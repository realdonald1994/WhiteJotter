...
After the command is executed successfully, a dist folder is generated under the wj-vue directory, and the two files static and index.html in the folder can be copied to nginx.Then enter the backend root directory and execute the command line：
